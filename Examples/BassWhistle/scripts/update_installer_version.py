...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=BassWhistle Demo Installer\n"
      else:
        line="OutputBaseFilename=BassWhistle Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the BassWhistle Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the BassWhistle installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=BassWhistle Demo installer\n"
     else:
       line="SetupWindowTitle=BassWhistle installer\n"
