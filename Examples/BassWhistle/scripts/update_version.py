...
def main():
  ...
  plistpath = scriptpath + "/resources/BassWhistle-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BassWhistle-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BassWhistle-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BassWhistle-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BassWhistle-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BassWhistle.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BassWhistle.iss",inplace=1):
